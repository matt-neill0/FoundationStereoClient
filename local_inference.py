...
class LocalEngineRunner:
    ...
    def __init__(
        ...
        self._preview_frame_source: Optional[str] = None
    ...
    def _result_metadata(self) -> Dict[str, Any]:
        ...
        if self._preview_frame_source:
            meta["preview_frame_source"] = self._preview_frame_source
        return meta
    ...
    def _preview_display_frame(self, left_bgr: np.ndarray) -> np.ndarray:
        ...
        self._preview_frame_source = "left_camera"
        return left_bgr
